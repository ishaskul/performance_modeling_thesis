        ...
        for machine in green_lab_machines:
            ...
            for input_file in files:
                ...
                if os.path.exists(output_file):
                    ...
                    continue  # Skip writing to this file
                ...
                with open(output_file, 'w', newline='') as csvfile:
                    ...
                    for line in lines:
                        ...
                        if len(splitted_line) < 8 or line.startswith("Average:") or "idle" in line:
                            continue
                        else:
...
input_base_dir = f'../../compose_posts'
output_base_dir = f'../../compose_posts/1/transformed_data/server_level_res_utilization_data'
