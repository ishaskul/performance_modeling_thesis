...
input_dir = '../../compose_posts/1/system_cpu_data'
container_pid_mapping_csv_dir = '../../compose_posts' 
output_base_dir = '../../compose_posts/1/transformed_data/cpu_util_data_per_container'
...
for server in servers:
    ...
    for json_file_path in json_files:
        ...
        for service, records in service_data.items():
            csv_file_path = os.path.join(output_dir,filtered_container_name, f"{service}.csv")
        ...
        if nginx_data:
            nginx_csv_path = os.path.join(output_dir,filtered_container_name,  "nginx.csv")
