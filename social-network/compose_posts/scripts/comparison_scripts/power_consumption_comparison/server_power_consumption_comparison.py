...
server_utilization_path = './social-network/compose_posts/compose_posts/1/transformed_data/server_level_res_utilization_data'
estimated_data_path = './social-network/compose_posts/estimations/estimated_power_consumption'
output_dir = './social-network/compose_posts/estimations/plots/power_consumption_comparison_plots'  # Directory to save the plots
