...
server_utilization_path = './bookstore/buy_books/buy_books_final/1/transformed_data/server_level_res_utilization_data'
estimated_data_path = './bookstore/buy_books/estimations/estimated_power_consumption'
output_dir = './bookstore/buy_books/estimations/plots/power_consumption_comparison_plots'  # Directory to save the plots
