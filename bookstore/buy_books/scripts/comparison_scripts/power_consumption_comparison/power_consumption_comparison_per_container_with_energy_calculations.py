...
power_consumption_data_path = './bookstore/buy_books/buy_books_final/1/transformed_data/power_consumption_data_per_container'
estimated_data_path = './bookstore/buy_books/estimations/estimated_power_consumption'
output_dir = './bookstore/buy_books/estimations/plots/power_consumption_comparison_plots'
...
for server in servers:
    for container in containers:
        try:
            ...
            # Trim data to the maximum overlapping time range
